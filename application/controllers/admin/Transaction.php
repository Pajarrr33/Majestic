...
class Transaction extends CI_Controller {
	...
	public function cancel($order_id)
	{
		...
		$response = $this->veritrans->cancel($order_id);
		if ($response === "Transaction canceled successfully.") {
			echo "Transaction canceled successfully.";
		} else {
			echo "Transaction cancellation failed: " . $response;
		}
	}
