		...
		<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-start">
			<div class="col-first">
				...
				<nav class="d-flex align-items-center">
                    ...
                    <a href="category.html">Update Adress</a>
				</nav>
			</div>
		</div>
	</div>
...
<section>
    <div class="container">
        ...
        <form action="<?= base_url('User/update_user_adress/' . $a->id) ?>" method="post">
            <h3 class="mb-3">Update Adress</h3>
            <div class="form-group">
                ...
                <input type="text" name="adress_name" value="<?= $a->address_name ?>" class="form-control" id="exampleInputEmail1" placeholder="Insert Your Adress Name" aria-describedby="emailHelp">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="<?= $a->name ?>" class="form-control" placeholder="Insert Your Name" id="exampleInputPassword1">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" value="<?= $a->email ?>" class="form-control" placeholder="Insert Your Email" id="exampleInputPassword1">
            ...
            <div class="form-group">
                ...
                <input type="number" name="number" value="<?= $a->phone ?>" class="form-control" placeholder="Insert Your Phone Number" id="exampleInputPassword1">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group province">
                        ...
                        <select name="province" id="" class="form-control"> 
                            <option value="<?= $a->id_province ?>"><?= $a->province ?></option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group example-select city">
                        ...
                        <select class="form-control" name="distrik" >
                            <option value="<?= $a->id_distrik?>"><?= $a->distrik ?></option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group mt-0 pt-0">
                ...
                <input type="text" name="street" value="<?= $a->street ?>" class="form-control" placeholder="Insert Your Street" id="exampleInputPassword1">
            </div>

            <div class="form_hidden">
                <input type="hidden" name="input_province" value="<?= $a->province ?>">
                <input type="hidden" name="input_distrik" value="<?= $a->distrik ?>">
            </div>
